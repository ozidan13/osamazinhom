...
export function Layout(content, pages = []) {
    ...
    return `
        <div class="app-container min-h-screen bg-gradient-to-br from-indigo-50 via-violet-50 to-fuchsia-50">
            <nav class="sticky top-0 z-50 backdrop-blur-lg bg-white/70 shadow-lg border border-white/20 p-4 mb-6 transition-all duration-300">
                <div class="container mx-auto flex items-center justify-between">
                    <div class="flex items-center space-x-6 rtl:space-x-reverse">
                        <a href="#/" class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-violet-600">Osama</a>
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">${navLinks}</div>
                    </div>
                    <div class="hidden sm:flex items-center space-x-4">
                        <a href="https://github.com" target="_blank" class="text-gray-600 hover:text-indigo-600 transition-colors duration-200">
                        ...
                        <a href="https://linkedin.com" target="_blank" class="text-gray-600 hover:text-indigo-600 transition-colors duration-200">
            ...
            <footer class="bg-white/70 border-t border-white/20 py-8 mt-12">
                <div class="container mx-auto px-4 text-center">
                    <p class="text-gray-600">© ${new Date().getFullYear()} Osama Zinhom. All rights reserved.</p>
                    <div class="flex justify-center space-x-4 mt-4">
                        <a href="mailto:osamazinhomzidan@gmail.com" class="text-gray-600 hover:text-indigo-600 transition-colors duration-200">
                        ...
                        <a href="https://behance.net" target="_blank" class="text-gray-600 hover:text-indigo-600 transition-colors duration-200">
